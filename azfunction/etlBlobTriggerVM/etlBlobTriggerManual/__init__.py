...
def main(etlblob: func.InputStream):
    ...
    source = 'manual'
    url = f'http://etlapivmssplastico-prod.northeurope.cloudapp.azure.com:8081/api/etlHttpTrigger?container={container}&blob={blob_name}&prediction=json&source={source}&target=postgre'
    payload = {}
    headers= {}
