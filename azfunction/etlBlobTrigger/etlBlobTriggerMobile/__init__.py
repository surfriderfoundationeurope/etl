...
def main(etlblob: func.InputStream):
    ...
    source = 'mobile'
    url = f'http://etlapiplastico-vmss-dev-ds3.westeurope.cloudapp.azure.com:8082/api/etlHttpTrigger?container={container}&blob={blob_name}&prediction=json&source={source}&target=csv'
    payload = {}
    headers= {}
