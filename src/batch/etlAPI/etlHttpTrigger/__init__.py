...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    log_id = req.params.get('logid')

    if container_name and blob_name and prediction_source and source_data and target_store and log_id:
        ...
        return func.HttpResponse(
            "Please pass a container name, a blob name, a prediction source from ['ai','json'], a source data from ['gopro','mobile','manual'], a target store from ['postgre','csv'] and a log_id",
            status_code=400
        )
